...
srcFiles = dir('C:\Users\CLOUD\Desktop\image');
for i = 1 : length(srcFiles)
    filename = strcat('C:\Users\CLOUD\Desktop\image',srcFiles(i).name);
    I = imread(filename);
 %  figure, imshow(I);

    
  %  image = 'C:\Users\sher\Desktop\project\FF\dd\image%f.jpg';
